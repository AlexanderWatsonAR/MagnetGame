...
namespace StylizedGrass
{
    public class ColorMapEditor : Editor
    {
        ...
        private static void RenderToTexture(GrassColorMapRenderer renderer)
        {
            ...
            EditorUtility.CompressTexture(render, renderer.layerScaleSettings.Count > 0 ? TextureFormat.PVRTC_RGBA4 : TextureFormat.DXT1, TextureCompressionQuality.Normal);
